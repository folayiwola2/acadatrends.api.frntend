...
import { createQuestions } from "../store/actions/projectActions";
...
class AddQuestions extends Component {
  ...
  componentDidMount() {
    ...
    fetch(`${base_url}/questionCategory/`)
      .then(res => {
        return res.json();
      })
      .then(data => {
  ...
  handleSubmit = async e => {
    ...
    await this.props.createQuestions(obj);
    let props = this.props;
    console.log("Props status", this.props);
    if (props.status === "Success") {
      swal("Response", "Questions Successful Created...", "success");
      this.props.history.push("/admin/view-questions");
    } else {
      this.setState({ isLoading: false });
      return swal("Response", "Questions creation failed...", "error");
    }
  };
          ...
          >
            ...
            <form className="form-group" onSubmit={this.handleSubmit}>
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  <textarea type="text" wrap="on" className="form-control" id="content" rows="3" placeholder="Questions Content" onChange={this.handleChange}></textarea>
...
const mapDispatchToProps = dispatch => {
  return {
    createQuestions: news => {
      return new Promise(resolve => {
        dispatch(
          createQuestions(news, res => {
            resolve(res);
          })
        );
      });
