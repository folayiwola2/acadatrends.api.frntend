...
class EditQuestions extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`${base_url}/questions/${id}`).then((response) => {
                ...
                <div className="main-content-container container-fluid px-4" style={{ background: "" }}>
                    ...
                    <div className="container" style={{ background: "white", height: "auto" }}><br /><br />
                        ...
                        <form className="form-group" onSubmit={this.handleSubmit}>
                            <div className="row">
                                <div className="col-md-2">Questions Title : </div>
                                <div className="col-md-8">
                                    <input type="text" className="form-control" value={state ? state.title : ""} id="title" placeholder="Questions Title" onChange={this.handleChange} />
                                </div>
                            </div><br /><br />


                            <div className="row">
                                <div className="col-md-2"> Questions Category: </div>
                                <div className="col-md-8">
                            ...
                            <div className="row">
                                <div className="col-md-2">Questions Content : </div>
                                <div className="col-md-8">
                                    <textarea type="text" wrap="on" className="form-control" value={state ? state.content : ""} id="content" rows="3" placeholder="Questions Content" onChange={this.handleChange} style={{ height: "30vh" }}></textarea>
                            ...
                            <div className="row">
                                <div className="col-md-2">Questions Author : </div>
                                <div className="col-md-8">
                                    <input type="text" className="form-control" value={state ? state.author : ""} disabled="true" id="author" placeholder="Questions Author" onChange={this.handleChange} />
                                </div>
                            </div><br /><br />
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-8">
                                    <button className={this.state.isLoading ? "mb-2 btn btn-primary mr-2 col-md-12 disabled" : "mb-2 btn btn-primary mr-2 col-md-12"} >
                                        {this.state.isLoading ? "Updating Questions..." : "Update Questions"}
                                    </button>
                                </div>
                            </div>
                        </form>
